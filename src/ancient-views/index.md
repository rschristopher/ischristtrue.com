...
We can blame globalism or populism but these are mere symptoms, the rotten fruits of nihilism.
...
If we experience anomalies (things that don't make sense) we will seek to integrate the anomalous phenomena into the old worldview -- failure to do so results in a kind of existential crisis (and hysteria) until a new worldview is adopted which can better make sense of the new phenomena.
 ...
 *Great Depression* 
 (tractors changing the economic reality of family farms). 
